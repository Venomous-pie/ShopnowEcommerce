...
SECRET_KEY = "django-insecure-@5mz66al7=c=#zwb!h$kjhi@1*n7()r^r=un++)7uxtg6zuif!"
...
# Tells Django to use JWT tokens to check if a user is logged in for all API requests
REST_FRAMEWORK = {
